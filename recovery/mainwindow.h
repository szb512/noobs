...
public:
  explicit MainWindow(const QString &defaultDisplay, QSplashScreen *splash,
                      QWidget *parent = 0);
  ~MainWindow();
...
protected:
  ...
  QListWidgetItem *searchForOlderItem(const QVariant &name,
...
protected slots:
  ...
  void onQuery(const QString &msg, const QString &title,
